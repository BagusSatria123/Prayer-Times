function prayerTimes(latitude, longitude) {
  fetch(
    ...
    .then(function (response) {
      //   console.log(response.data[1].timings);
      let date = new Date();
...
function error() {
  ...
  //default meggunakan latitude jakarta
...
function userLocation() {
  if (!navigator.geolocation) {
    alert(
      "Geolocation tidak di dukung didalam browser anda, silahkan gunakan browser lainnya"
    );
  } else {
